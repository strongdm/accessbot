...
* **SDM_AUTO_APPROVE_TAG**. Tag to be used for auto-approve resources. The value can be `true` or a list of groups (see `SDM_GROUPS_TAG`) separated by comma. The tag value is not ignored, delete tag or set it false to disable. Default = None
