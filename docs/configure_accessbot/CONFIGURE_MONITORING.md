...
![Captura de Tela 2022-05-17 às 09 12 19](https://user-images.githubusercontent.com/49597325/168816013-b71ff2b5-be8b-45ea-9a58-4cec4e51cb53.png)

2 - Access Requests Count (`accessbot_total_access_requests` metric):

![Captura de Tela 2022-05-17 às 09 12 29](https://user-images.githubusercontent.com/49597325/168816036-f51baf75-67ed-4735-be77-51e2f9ce379a.png)

3 - Pending Access Requests Count (`accessbot_total_pending_access_requests` metric):

![Captura de Tela 2022-05-17 às 09 12 38](https://user-images.githubusercontent.com/49597325/168816111-8b330af8-110c-4dc4-96f2-6ff554e6703b.png)

4 - Manually Approved Access Requests Count (`accessbot_total_manual_approves` metric):

![Captura de Tela 2022-05-17 às 09 12 45](https://user-images.githubusercontent.com/49597325/168816119-344c8c2c-ddad-4008-a5c6-4ee8c02fb66f.png)

5 - Auto Approved Access Requests Count (`accessbot_total_auto_approves` metric):

![Captura de Tela 2022-05-17 às 09 12 52](https://user-images.githubusercontent.com/49597325/168816132-755b62f2-da7c-49ab-9c7f-bf20b5b0162b.png)

6 - Manually Denied Access Requests Count (`accessbot_total_denied_access_requests` metric):

![Captura de Tela 2022-05-17 às 09 12 59](https://user-images.githubusercontent.com/49597325/168816152-1ffbffe7-128e-475a-9ba4-2971431c380d.png)

7 - Timed Out Access Requests Count (`accessbot_total_timed_out_access_requests` metric):

![Captura de Tela 2022-05-17 às 09 13 06](https://user-images.githubusercontent.com/49597325/168816166-8deb901e-ccfd-4101-9ae7-8e290f429ea6.png)

8 - Total Consecutive Errors Count (`accessbot_total_consecutive_errors` metric):

![Captura de Tela 2022-05-17 às 09 10 42](https://user-images.githubusercontent.com/49597325/168816189-a559a694-2790-49be-87a0-1d06f4a73cb4.png)
...
![Captura de Tela 2022-05-17 às 09 10 33](https://user-images.githubusercontent.com/49597325/168816198-c76173b2-cb18-4799-9590-d7405bf5496f.png)
