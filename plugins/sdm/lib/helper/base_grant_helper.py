...
class BaseGrantHelper(ABC):
    ...
    def __grant_access(self, message, sdm_object, sdm_account, execution_id, request_id):
        ...
        if not self.__needs_auto_approve(sdm_object, sdm_account) or self.__reached_max_auto_approve_uses(message.frm.person):
    ...
    def __needs_auto_approve(self, sdm_object, sdm_account):
        ...
        return is_auto_approve_all_enabled or can_auto_approve_by_tag(self.__bot.config, sdm_object, self.__auto_approve_tag_key, sdm_account)
