...
class BaseGrantHelper:
    ...
    def grant_access(self, message, sdm_object, sdm_account, execution_id, request_id):
    ...
    def __notify_access_request_entered(self, sender_nick, resource_name, request_id):
        ...
        operation_desc = "access" if self.__grant_type == GrantRequestType.ACCESS_RESOURCE else "role assign"
    ...
    def try_fuzzy_matching(self, execution_id, term_list, role_name):
