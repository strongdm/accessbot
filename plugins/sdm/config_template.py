...
_INSTANCE = {
    ...
    'ALLOW_RESOURCE_GROUPS_TAG': os.getenv("SDM_ALLOW_RESOURCE_GROUPS_TAG"),
    'ALLOW_ROLE_GROUPS_TAG': os.getenv("SDM_ALLOW_ROLE_GROUPS_TAG"),
    ...
    'ADMINS_CHANNEL_ELEVATE': str(os.getenv("SDM_ADMINS_CHANNEL_ELEVATE", "")).lower() == 'true',
    ...
    'USE_ALTERNATIVE_EMAILS': str(os.getenv("SDM_USE_ALTERNATIVE_EMAILS", "").lower() == 'true'),
}
